...
PARAMETERS_TO_SYNC = {
    ...
    'START_READY_WAIT_BUDGET_SECONDS': f'{SSM_BASE}START_READY_WAIT_BUDGET_SECONDS',
    'SERVER_RUN_MODE': f'{SSM_BASE}SERVER_RUN_MODE',
    'INSTANCE_LIFECYCLE_MODE': f'{SSM_BASE}INSTANCE_LIFECYCLE_MODE',
    'DYNAMIC_CAPACITY_MODE': f'{SSM_BASE}DYNAMIC_CAPACITY_MODE',
    'BASE_AMI_ID': f'{SSM_BASE}BASE_AMI_ID',
    'LAUNCH_TEMPLATE_ID': f'{SSM_BASE}LAUNCH_TEMPLATE_ID',
    'LAUNCH_TEMPLATE_VERSION': f'{SSM_BASE}LAUNCH_TEMPLATE_VERSION',
    'SUBNET_ID': f'{SSM_BASE}SUBNET_ID',
    'SECURITY_GROUP_IDS': f'{SSM_BASE}SECURITY_GROUP_IDS',
    'INSTANCE_TYPE': f'{SSM_BASE}INSTANCE_TYPE',
    'KEY_NAME': f'{SSM_BASE}KEY_NAME',
    'EC2_INSTANCE_PROFILE_NAME': f'{SSM_BASE}EC2_INSTANCE_PROFILE_NAME',
    'DYNAMIC_SHUTDOWN_ACTION': f'{SSM_BASE}DYNAMIC_SHUTDOWN_ACTION',
    'FACTORIO_VERSION': f'{SSM_BASE}FACTORIO_VERSION',
}
